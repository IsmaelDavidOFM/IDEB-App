...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a href="{{ url('/') }}">
                <img src="/img/Instituto_IDEB_Logotipo_0.png"
                    alt="" width="150" height="80" class="d-inline-block align-text-top">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item me-3">
                        <a href="{{ url('/carrito') }}" class="btn position-relative p-0" style="border: none; background: transparent;">
                            <i class="bi bi-book" style="font-size: 2rem; color: #fff;"></i>
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: .8rem; width: 1.3rem; height: 1.3rem; display: flex; align-items: center; justify-content: center;">
